...
import com.linkedin.batch.etl.kafka.common.KafkaClient;
...
public class EtlInputFormat extends InputFormat<EtlKey, AvroWrapper<Object>> {
    ...
    public List<InputSplit> getSplits(JobContext context) throws IOException, InterruptedException {
        ...
        // TODO : The API to fetch the list of topics from Kafka is getting
        // deprecated.
        // Further information to come.
        // Try to create the new requests... If not available, use the previous
        // requests
        try {
            ...
            System.err
                    .println("Unable to get the metadata information from the Kafka VIP. Using the previous requests");
    ...
    public List<String> getTopicsList(JobContext context) {
        try {
            ...
            zkClient = new EtlZkClient(zkHosts, zkSessionTimeout, zkConnectionTimeout, zkTopicPath,
                    zkBrokerPath);
            ...
            System.err
                    .println("Unable to connect to the zookeeper to fetch the list of topics. Reading the topics from the previous requests.");
            return null;
        }
    }
    ...
    public static int getKafkaClientBufferSize(JobContext job) {
        return job.getConfiguration().getInt(EtlJob.KAFKA_CLIENT_BUFFER_SIZE, 2 * 1024 * 1024);
    }
